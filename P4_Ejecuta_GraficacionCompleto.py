...
class MyApp(QtWidgets.QMainWindow, interfaz.Ui_MainWindow):
    def __init__(self):
        ...
        # Configuración del color de fondo y tamaño de la fuente
        self.setStyleSheet("background-color: #E0FFFF; font-size: 15px;")  # Azul claro pero no intenso, fuente más pequeña
